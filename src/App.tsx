      ...
      <Grid>
        ...
        <Card id="publications" title="Publications">
          <ul>
            ...
            <ListItem><em>Lorince, J.</em>, Zorowitz, S., Murdock, J., & Todd, P. M. (2014). <a href="https://dl.acm.org/doi/10.1145/2615569.2615686" target="_blank" rel="noreferrer">"Supertagger" behavior in building folksonomies</a>. Proceedings of the 6th Annual ACM Web Science Conference.</ListItem>
            <ListItem><em>Lorince, J.</em>, & Todd, P. M. (2013). <a href="https://dl.acm.org/doi/10.1145/2464464.2464516" target="_blank" rel="noreferrer">Can simple social copying heuristics explain tag popularity in a collaborative tagging system?</a> Proceedings of the 5th Annual ACM Web Science Conference.</ListItem>
            <ListItem>Veinott, E. S., Leonard, J., Papautsky, E. L., Perelman, B., Stankovic, A., <em>Lorince, J.</em>, et al. (2013). <a href="https://ieeexplore.ieee.org/document/6659170/" target="_blank" rel="noreferrer">The effect of camera perspective and session duration on training decision making in a serious video game</a>. Proceedings of the 2013 IEEE Games Innovation Conference.</ListItem>
            <ListItem>Mullinix, G., Gray, O., Colado, J., Veinott, E., Leonard, J., Papautsky, E. L., ..., <em>Lorince, J.</em>, et al. (2013). <a href="https://ieeexplore.ieee.org/document/6659159/" target="_blank" rel="noreferrer">Heuristica: Designing a serious game for improving decision making</a>. Proceedings of the 2013 IEEE Games Innovation Conference.</ListItem>
            <ListItem><em>Lorince, J.</em> (2016). <a href="https://scholarworks.iu.edu/iuswrrest/api/core/bitstreams/f0e483dd-be01-43ec-8d4a-18e4bccb32c6/content" target="_blank" rel="noreferrer">Consumption of Content on the Web: An Ecologically Inspired Perspective</a>. (Doctoral dissertation, Indiana University).</ListItem>
          </ul>
        </Card>
      </Grid>
    </DefaultLayout>
